...
st.markdown("---")
### Define Menu--------------
sub_menus = {"Frontera Eficiencia":["Modelo Markowitz","Sharpe Ratio"],
             "ETFS métricas":["Retonos/beta", "Rentabilidad/Riesgo","Frontera Eficiencia"]
            }
# Optinally you can supply google icons
sub_menu_icons = {
                  "Frontera Eficiencia": ["leaderboard", "multiline_chart","trending_up","candlestick_chart"], 
                  "ETFS métricas": ["leaderboard", "multiline_chart","trending_up"]    
                }
...
sub_menu_imgs = {"Frontera Eficiencia":list_of_finance_imgs,
                  "ETFS métricas":list_of_dolar_imgs
                }
